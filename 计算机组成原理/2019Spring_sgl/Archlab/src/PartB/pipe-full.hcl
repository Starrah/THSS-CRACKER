...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	  IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, IIADDL ,ILEAVE,RMXCHG,CMP};
...
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL, IIADDL,RMXCHG ,CMP};

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, IIADDL,RMXCHG };
...
int d_srcA = [
	D_icode in { IRRMOVL, IRMMOVL, IOPL, IPUSHL,RMXCHG,CMP} : D_rA;
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IMRMOVL ,IIADDL,RMXCHG,CMP} : D_rB;
...
int d_dstM = [
	D_icode in { IMRMOVL, IPOPL,RMXCHG } : D_rA;
	D_icode in { ILEAVE}:REBP;
	1 : RNONE;  # Don't write any register
];
...
int aluA = [
	E_icode in { IRRMOVL, IOPL, ILEAVE, CMP } : E_valA;
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL ,RMXCHG} : E_valC;
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		     IPUSHL, IRET, IPOPL ,IIADDL,RMXCHG, CMP} : E_valB;
	E_icode in {ILEAVE}: 4;
...
bool set_cc = E_icode in { IOPL, IIADDL,CMP } &&
...
int mem_addr = [
	M_icode in { IRMMOVL, IPUSHL, ICALL, IMRMOVL,RMXCHG } : M_valE;
	M_icode in { IPOPL, IRET, ILEAVE} : M_valA;
	# Other instructions don't need address
];

## Set read control signal
bool mem_read = M_icode in { IMRMOVL, IPOPL, IRET ,ILEAVE,RMXCHG};

## Set write control signal
bool mem_write = M_icode in { IRMMOVL, IPUSHL, ICALL ,RMXCHG};
...
bool F_stall =
	...
	E_icode in { IMRMOVL, IPOPL, ILEAVE,RMXCHG } &&
...
bool D_bubble =
	...
	!(E_icode in { IMRMOVL, IPOPL ,ILEAVE,RMXCHG} && E_dstM in { d_srcA, d_srcB }) &&
	  IRET in { D_icode, E_icode, M_icode };
