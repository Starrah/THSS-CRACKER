...
def load_data(data_dir = "../data/",input_size = 224,batch_size = 36):
    ...
    image_dataset_debug = datasets.ImageFolder(os.path.join(data_dir,'debug'), data_transforms['train'])
    ...
    debug_loader = DataLoader(image_dataset_debug, batch_size=batch_size, shuffle=True, num_workers=4)
    return train_loader, valid_loader, debug_loader
