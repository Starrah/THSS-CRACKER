...
class DeepDream():
    ...
    """
    def __init__(self, model, selected_layer, selected_filter, im_path, save_folder):
        self.model = model
        self.model.eval()
        ...
        if not os.path.exists('../result/generated/deep_dream'):
            os.makedirs('../result/generated/deep_dream')
